...
make_samples <- function(df, vars.numeric, target, minority.value, muestra, knn, seed, cl){
...
### Función SMOTE ENC
SMOTE_ENC <- function(df, target, minority.value, vars.numeric, k, seed){
    ...
    Synthetic <- make_samples(df, vars.numeric, target, minority.value, new_index, knn, seed, cl)
